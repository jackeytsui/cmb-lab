...
export default async function AdminAssessmentsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-zinc-100">Admin Assessment Builder</h1>
        <p className="mt-1 text-sm text-zinc-400">Create placement quizzes, HSK mocks, and custom assessments.</p>
      </div>
