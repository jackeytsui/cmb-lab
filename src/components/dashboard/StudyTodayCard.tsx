      ...
      <div className="grid lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
        <div className="border-b border-border p-5 sm:p-6 lg:border-b-0 lg:border-r">
          ...
          <div className="mt-4 flex items-center gap-2 rounded-lg bg-emerald-500/[0.08] px-3 py-2.5 text-xs text-emerald-700 dark:text-emerald-300">
            ...
            The suggestions currently total {suggested} minutes. Your goal is {goal}{" "}
            minutes—pick what fits today.
          </div>
        </div>
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                A personalized starting point when you are unsure what to study.
              </p>
            </div>
            <BrainCircuit className="h-5 w-5 text-primary/60" aria-hidden="true" />
          </div>

          <div className="mt-3 rounded-lg border border-primary/10 bg-primary/[0.045] px-3 py-2.5 text-xs leading-5 text-muted-foreground">
            These are not assignments. CMB Lab updates them from your due reviews,
            recent practice and tone results, and saved grammar. Start with #1, or
            choose any activity that fits your time today.
          </div>
