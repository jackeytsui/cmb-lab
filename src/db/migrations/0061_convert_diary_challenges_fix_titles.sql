-- Corrected version of 0060: the diary-challenge courses are actually titled
-- "The Canto to Mando Blueprint - Intermediate" and "…- Advanced" (0060 matched
-- the literal titles Intermediate/Advanced and so converted zero rows).
--
-- Converts the "Diary Challenge N" Text lessons in those two courses (13 + 13)
-- to the Diary lesson type, keeping their titles and setting the content to the
-- standard default diary instructions (Mandarin variant — these are "Canto to
-- Mando" courses, i.e. learning Mandarin).
--
-- Idempotent + tightly scoped: only lessons still typed 'text', titled "…diary…",
-- in those two courses. Re-running is a no-op.
